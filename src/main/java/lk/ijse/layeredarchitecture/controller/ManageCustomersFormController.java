...
public class ManageCustomersFormController {
    ...
    private void loadAllCustomers() {
        ...
        try {
            ...
            ArrayList<CustomerDTO> allCustomer = customerBoimpl.getAll();
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            ...
            try {
                ...
                boolean isSave = customerBoimpl.saveCustomer(customerDTO);
            ...
            try {
                ...
                boolean isUpdate = customerBoimpl.updateCustomer(customerDTO);
    ...
    public void btnDelete_OnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            boolean isDelete = customerBoimpl.deleteCustomer(customerDTO);
