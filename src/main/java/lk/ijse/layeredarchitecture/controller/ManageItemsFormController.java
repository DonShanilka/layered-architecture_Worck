...
public class ManageItemsFormController {
    ...
    private void loadAllItems() {
        ...
        try {
            ...
            ArrayList <ItemDTO> allItem = itemBoimpl.loadAllItem();
    ...
    public void btnDelete_OnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            boolean isdelete = itemBoimpl.delete(itemDTO);
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            try {
                ...
                boolean isSave = itemBoimpl.save(itemDTO);
            ...
            try {
                ...
                boolean isUpdate = itemBoimpl.update(itemDTO);
    ...
    private String generateNewId() {
        try {
            //ItemDAOInterface itemDAOimpl = new ItemDAOimpl();
            String newId = itemBoimpl.genarateNewId();
            return newId;
